...
| Package | Owns |
|---|---|
| `internal/liquidlane` | adapter/vault/route types, latest-state reads (adapter or optional liquidity lens), direct authorization, ids, rate math, and the pending-capacity ledger |
