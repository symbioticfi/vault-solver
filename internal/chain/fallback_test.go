...
func TestDial_SingleHTTPEndpointServesChainID(t *testing.T) {
	...
	c, err := Dial(t.Context(), []string{srv.URL}, "", "", multicall, defaultRPCAttemptTimeout)
	if err != nil {
...
func TestDial_FallbackServesChainID(t *testing.T) {
	...
	const multicall = "0xcA11bde05977b3631167028862bE2a173976CA11"
	c, err := Dial(t.Context(), []string{primary.URL, fallback.URL}, "", "", multicall, defaultRPCAttemptTimeout)
	if err != nil {
...
func TestDial_WriteRPCRoutesBroadcastsAndNonces(t *testing.T) {
	...
	c, err := DialWithMetrics(
		t.Context(), []string{read.URL}, write.URL, "", multicall, 0, rpcMetrics,
	)
	if err != nil {
		t.Fatalf("Dial: %v", err)
	}
...
func TestDialDoesNotFollowRPCRedirects(t *testing.T) {
	...
	client, err := DialWithMetrics(
		t.Context(), []string{redirect.URL}, "", "", multicall, 0, metrics,
	)
...
func TestTransactionSenderBalanceFallsBackWhenWriteRPCRejectsRead(t *testing.T) {
	...
	const multicall = "0xcA11bde05977b3631167028862bE2a173976CA11"
	client, err := Dial(t.Context(), []string{read.URL}, write.URL, "", multicall, defaultRPCAttemptTimeout)
	if err != nil {
		t.Fatalf("Dial: %v", err)
	}
	defer client.Close()
...
func TestDial_RejectsMismatchedWriteRPCChainID(t *testing.T) {
	...
	const multicall = "0xcA11bde05977b3631167028862bE2a173976CA11"
	c, err := Dial(t.Context(), []string{read.URL}, write.URL, "", multicall, defaultRPCAttemptTimeout)
...
func TestMulticallUsesLatestBlockTag(t *testing.T) {
	...
	const multicall = "0xcA11bde05977b3631167028862bE2a173976CA11"
	c, err := Dial(t.Context(), []string{server.URL}, "", "", multicall, defaultRPCAttemptTimeout)
	if err != nil {
		t.Fatalf("Dial: %v", err)
	}
	defer c.Close()
