...
func plannerWireBig(t *testing.T, s string) *big.Int {
	t.Helper()
...
func TestQuoteInputMarshalJSONWireShape(t *testing.T) {
	...
	input := QuoteInput{
		...
		AmountIn:           plannerWireBig(t, "1000000000000000000"),
		RequireSingleRoute: true,
		Candidates: []liquidlane.QuoteCandidate{{
			ID:           "candidate-1",
			Route:        route,
			MaxAmountOut: plannerWireBig(t, "1000000"),
			Rate:         plannerWireBig(t, "1000000000000000000"),
