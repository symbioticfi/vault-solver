...
func TestCandidatePriceSource(t *testing.T) {
	...
	auction := AuctionMessage{Payload: AuctionPayload{Prices: map[string]string{oracle.Hex(): framePx.String()}}}
...
func TestCandidateRequiresAuctionPriceForMarketOracle(t *testing.T) {
	...
	auction := AuctionMessage{Payload: AuctionPayload{Prices: map[string]string{
		otherOracle.Hex(): "1000000000000000000000000000",
		"not-an-address":  "1000000000000000000000000000",
		oracle.Hex():      "0",
	}}}
...
func TestSnapshotFreshForAuction(t *testing.T) {
	...
	auction := AuctionMessage{Timestamp: auctionAt}
...
func TestAPIMarketSnapshotKeepsLatestBlockOnly(t *testing.T) {
	...
	snap := (&apiMonitor{log: logr.Discard()}).apiMarketSnapshot([]morphoMarket{old, latest}, loan, []common.Address{coll}, true)
