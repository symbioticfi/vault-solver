...
// APIClient manages communication with the Symbiotic RFQ Backend API API v1.0.0
...
type APIClient struct {
	...
	DevelopmentAPI *DevelopmentAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.DevelopmentAPI = (*DevelopmentAPIService)(&c.common)
